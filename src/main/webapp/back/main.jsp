...
<title>持名法州主页</title>
   <link rel="stylesheet" type="text/css" href="../back/themes/gray/easyui.css">   
   <link rel="stylesheet" type="text/css" href="../back/themes/icon.css">
   <link rel="stylesheet" type="text/css" href="../back/themes/IconExtension.css">     
   <script type="text/javascript" src="../back/easyUi/jquery.js"></script>   

...
import com.xzr.util.FileBrowserUtil;
...
public class ImageBrowserController {
	...
	public void upload(MultipartFile photo,HttpServletRequest request,HttpServletResponse response){
		...
		try {
			...
			String originalFilename = UUID.randomUUID().toString()+"."+FilenameUtils.getExtension(photo.getOriginalFilename());
